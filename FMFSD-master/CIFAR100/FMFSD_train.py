...
parser.add_argument('--model', default="resnet34", type=str, help="resnet18|resnet34|resnet50|resnet101|resnet152|"
...
if __name__ == "__main__":
    ...
    for epoch in range(args.epoch):
        ...
        with torch.no_grad():
            ...
            if correct[4] / total > best_acc4:
                best_acc4 = correct[4]/total
                print("ensemble Best Accuracy Updated: ", best_acc4 * 100)
            ...
            if correct[0] / total > best_acc:
                ...
                torch.save(net.state_dict(), "data/"+str(args.model)+".pth")
            print("EPOCH=%d,main Best Accuracy=%.3f,bran3 Best Accuracy=%.3f,bran2 Best Accuracy=%.3f,bran1 Best Accuracy=%.3f,ensemble Best Accuracy=%.3f" % (epoch+1, best_acc,best_acc1,best_acc2,best_acc3,best_acc4))
    print("Training Finished, TotalEPOCH=%d,main Best Accuracy=%.3f,bran3 Best Accuracy=%.3f,bran2 Best Accuracy=%.3f,bran1 Best Accuracy=%.3f,ensemble Best Accuracy=%.3f" % (args.epoch, best_acc,best_acc1,best_acc2,best_acc3,best_acc4))